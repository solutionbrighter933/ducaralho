/*
  # Adicionar coluna direcao de volta na tabela mensagens_whatsapp

  1. Problema
    - A coluna "direcao" foi removida acidentalmente da tabela mensagens_whatsapp
    - Esta coluna é essencial para determinar se a mensagem foi enviada ou recebida
    - Sem ela, não conseguimos exibir as mensagens corretamente na interface

  2. Solução
    - Adicionar a coluna "direcao" de volta
    - Migrar dados existentes baseado em outras colunas se necessário
    - Garantir que a coluna seja NOT NULL com valores válidos

  3. Valores válidos
    - 'sent' = mensagem enviada pelo usuário (lado direito)
    - 'received' = mensagem recebida do contato (lado esquerdo)
*/
